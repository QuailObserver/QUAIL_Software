...
// char *portname = "/dev/cu.usbserial-FT2HLMFD";
// portname = "/dev/cu.usbserial-FT2HLMFD"; -396384072; 
...
int value_from_focus_command_key(char *key)
{
    //printf("Hello World value from focus command key");
    int i;
...
{   
    ...
    if (verbose)
        ...
        //int portaddress = &portname;
        /* printf("%d", portaddress, "\n"); */
        //printf("Port Name = %s\n", portname, "\n");
...
int FocuserSetVerboseMode(int fd)
{
    //printf("Hello World Verbose Mode");
    char rbuf[128];
...
int FocuserSendRawCommand(int fd, char command[16]) 
{
    //printf("Hello World Raw Command");
    char rbuf[128];
...
int GetCurrentFocuserPosition(int fd)
{
    //printf("Hello World Get Current Position");
    char rbuf[128];
...
int FocuserPrintStatus(int fd)
{
    ...
    *(rbuf + count) = '\0';
    ...
    //printf(" Hello World Main! FocuserPrintStatus ");
    //fprintf(stdout,"CurrentValue: %s\n",rbuf);
...
int main(int argc, char *argv[]) {
    ...
    switch(action)
    {
       ...
       case FOCUSER_CURRENT_POSITION:
            //printf(" Hello World Main! CURRENT POSITION ");
           // fprintf(stdout,"CurrentValue: %d\n",fd);
            FocuserPrintCurrentPosition(fd);
            break;
       case FOCUSER_STATUS:
            //printf(" Hello World Main! STATUS ");
           // fprintf(stdout,"CurrentValue: %d\n",fd);
            FocuserPrintStatus(fd);            
            break;
       case FOCUSER_GOTO:
            //printf(" Hello World Main! GOTO ");
           // fprintf(stdout,"CurrentValue: %d\n",fd);
